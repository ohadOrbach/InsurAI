...
### Task Management
ENABLE_TASK_PARSING: true
# If true, enable automatic PRD parsing and task management

AUTO_TASK_PROGRESSION: false
# If true, automatically select next task after completion

REQUIRE_TASK_CONFIRMATION: true
# If true, require user confirmation before executing tasks

TASK_PRIORITY_ORDER: "HIGH_FIRST"
# Possible values: "HIGH_FIRST", "LOW_FIRST", "DEPENDENCY_ORDER"
# Controls how tasks are prioritized for execution

AUTO_ITERATE_TASKS: false
# If true, allow `/iterate-tasks` to run without individual confirmations

TASK_MODE_ALIGNMENT: true
# If true, automatically switch RIPER modes based on task requirements
...
# If true, automatically update task progress in memory files

TASK_PROGRESS_FREQUENCY: "AFTER_SUBTASK"
# Possible values: "REAL_TIME", "AFTER_SUBTASK", "AFTER_TASK", "MANUAL_ONLY"
# Controls when task progress is saved to memory

AUTO_UPDATE_CURRENT_TASK: true
# If true, automatically update current-task.json when tasks are selected

PRESERVE_TASK_HISTORY: true
# If true, maintain detailed task completion history in progress-log.md
